...
- Source: https://processing.org/reference/rotatex_
- Original URL: https://processing.org/reference/rotatex_
- Kind: processing-reference
- Purpose: 3D transform semantics along the x-axis.
- Fetched: 2026-03-25T21:29:54.368Z

## Extracted text

rotateX() / Reference / Processing.org
Processing
Foundation
Processing
p5.js
